          ...
          <div className="max-w-screen-2xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                <h1 className="font-hero font-normal text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-6 sm:mb-8 drop-shadow-lg hero-title text-white">
          ...
          <div className="max-w-screen-2xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-4xl mx-auto text-body">
                Experience the prestigious academic environment of the University of Cambridge through our comprehensive summer program
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  ...
                  With over 800 years of academic tradition, the University of Cambridge has produced 121 Nobel laureates and countless 
