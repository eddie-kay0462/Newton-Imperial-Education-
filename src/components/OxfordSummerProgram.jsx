          ...
          <div className="max-w-screen-2xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <img 
                  src="/campuses/oxford-campus.jpg" 
        ...
        <div className="w-full max-w-none mx-auto px-6 sm:px-12 lg:px-16 xl:px-20 2xl:px-28">
          <div className="max-w-screen-2xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-semibold text-gray-900 mb-6 text-heading">
                Program Overview
              </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gray-50 rounded-2xl p-8 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-4 card-title">Duration</h3>
              ...
              <div className="bg-gray-50 rounded-2xl p-8 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-4 card-title">Mentorship</h3>
                <p className="text-gray-600 card-description">Direct guidance from Oxford PhD candidates and researchers</p>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-8 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-4 card-title">Research</h3>
