          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="bg-white border border-gray-200/30 rounded-3xl p-10 lg:p-12 group hover:shadow-md transition-all duration-300 shadow-sm">
              <div className="text-center mb-8">
                <div className="hidden lg:flex w-20 h-20 rounded-2xl items-center justify-center mr-6 shadow-sm mx-auto mb-4" style={{ backgroundColor: '#0F2A44' }}>
              ...
              <p className="text-base lg:text-lg text-gray-600 leading-relaxed text-center lg:text-left lg:text-justify">
