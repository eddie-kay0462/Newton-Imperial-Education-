        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-100 mb-8 max-w-2xl mx-auto">
              Build the leadership skills necessary to succeed in both academic and personal life
            </p>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              ...
              <div className="prose max-w-none">
                <p className="text-gray-700 text-lg leading-relaxed mb-8">
                  ...
                  This comprehensive program combines practical leadership activities with personal reflection to help you develop authentic leadership capabilities.
                </p>

                <div className="bg-primary-50 rounded-lg p-6 mb-8">
                  <h3 className="text-xl font-semibold text-primary-900 mb-4">Program Format</h3>
                  <p className="text-primary-800">
                    Leadership activities, personal reflection journals, peer feedback sessions.
                  </p>
                </div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Essential Leadership Skills</h4>
                      <p className="text-gray-600">Gain insights into effective communication, teamwork, and decision-making.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Personal Growth & Confidence</h4>
                      <p className="text-gray-600">Develop self-confidence and emotional intelligence.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">Goal Setting & Achievement</h4>
                      <p className="text-gray-600">Learn how to set and achieve personal and academic goals.</p>
                    </div>
                  </div>
                </div>

                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Ready to Lead Your Future?</h3>
                  <p className="text-gray-600 mb-6">
                    Join students who have transformed their leadership capabilities and are making a positive impact in their communities and academic pursuits.
                  </p>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="font-medium">Interactive & Reflective</div>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t pt-6">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-center">
                    ...
                    Leadership activities & exercises
                  </li>
                  <li className="flex items-center">
                    <svg className="w-4 h-4 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <div className="mt-6 pt-6 border-t">
                ...
                <div className="text-sm text-gray-600">
                  <p>Leadership Development Team</p>
                  <p>Email: leadership@newton.edu</p>
